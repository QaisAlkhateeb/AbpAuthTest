...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        //MAUI Client
        var mauiClientId = configurationSection["TodoApp_Maui:ClientId"];
        if (!mauiClientId.IsNullOrWhiteSpace())
        {
            var mauiClientRootUrl = configurationSection["TodoApp_Maui:RootUrl"]?.Replace("_", "-");
            await CreateApplicationAsync(
                name: mauiClientId!,
                type: OpenIddictConstants.ClientTypes.Public,
                consentType: OpenIddictConstants.ConsentTypes.Implicit,
        ...
        //MAUI Blazor Client
        var mauiBlazorClientId = configurationSection["TodoApp_MauiBlazor:ClientId"];
        if (!mauiBlazorClientId.IsNullOrWhiteSpace())
        {
            var mauiBlazorClientRootUrl = configurationSection["TodoApp_MauiBlazor:RootUrl"]?.Replace("_", "-");
            await CreateApplicationAsync(
        ...
        // Web Public Client
        var webPublicClientId = configurationSection["TodoApp_Web_Public:ClientId"];
        if (!webPublicClientId.IsNullOrWhiteSpace())
        {
            var webPublicRootUrl = configurationSection["TodoApp_Web_Public:RootUrl"].EnsureEndsWith('/');
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["TodoApp_Web_Public:ClientSecret"] ?? "1q2w3e*",
                grantTypes: new List<string> //Hybrid flow
                {
                    OpenIddictConstants.GrantTypes.AuthorizationCode,
                    OpenIddictConstants.GrantTypes.Implicit
        ...
        var webPublicTieredClientId = configurationSection["TodoApp_Web_Public_Tiered:ClientId"];
        if (!webPublicTieredClientId.IsNullOrWhiteSpace())
        {
            var webPublicTieredRootUrl = configurationSection["TodoApp_Web_Public_Tiered:RootUrl"].EnsureEndsWith('/');
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["TodoApp_Web_Public_Tiered:ClientSecret"] ?? "1q2w3e*",
                grantTypes: new List<string> //Hybrid flow
                {
                    OpenIddictConstants.GrantTypes.AuthorizationCode,
                    OpenIddictConstants.GrantTypes.Implicit
